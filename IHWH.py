...
def ihotwaterh(device_demand, routine, mininterval, cost, hh_threshold, shifting, test):
    # general IHWH inputs
    ...
    # inputs especially for IHWH optimsiation using minimisation 1:
    ...
    # inputs especially for IHWH optimsiation using shifting 1:
    shift1_thres = 9                            # how much effort it takes to shift device usage
    shift1_time = 30                            # how long can the use of the device be shifted
    ...
    if test == 1 and hh_threshold >= shift1_thres:
        ...
        print " Opti ShifP Demand: (" + str(shift1_thres) + ") (" + str(len(optimised_demand)) + ") " + str(optimised_demand)
...
def test0():                    # test shifting
    ...
    variation = ihotwaterh(device_demand, routine_, min_interval, cost_, threshold, shifting_, testing_)
