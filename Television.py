...
def television(device_demand, routine, mininterval, cost, hh_threshold, shifting, test):
    # general TV inputs
    ...
    # inputs especially for TV optimsiation using elimination:
    elim_thres = 10                             # how much effort it takes to eliminate device usage

    # inputs especially for TV optimsiation using minimisation 1:
    ...
    mini1_cyclemax = 99999                      # if type cycle, what is the maximum amount of cycles...
    mini1_time = 999999                         # if type cycle, ...within a given time frame
...
def test0():                    # test shifting
    ...
    device_demand = appliancedemand[0][11]
    variation = television(device_demand, routine_, min_interval, cost_, threshold, shifting_, testing_)
