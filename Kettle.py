...
def kettle(device_demand, routine, mininterval, cost, hh_threshold, test):
    # general kettle inputs
    ...
    # inputs especially for kettle optimsiation using minimisation 1:
...
def test0():                    # test shifting
    ...
    device_demand = appliancedemand[0][8]
    variation = kettle(device_demand, routine_, min_interval, cost_, threshold, testing_)
