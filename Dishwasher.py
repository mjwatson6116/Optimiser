...
def dishwasher(device_demand, routine, mininterval, cost, hh_threshold, shifting, test):
    # general dishwasher inputs
    ...
    # inputs especially for dishwasher optimsiation using minimisation 1:
    ...
    # inputs especially for dishwasher optimsiation using shifting 1:
    ...
    # inputs especially for dishwasher optimsiation using shifting 2:
    ...
    # inputs especially for dishwasher optimsiation using shifting 3:
    ...
    if test == 1 and hh_threshold >= mini1_thres:
        print " Opti Mini1 Demand: (" + str(mini1_thres) + ") " + str(optimised_demand) + " (" + str(len(optimised_demand)) + ")"
    elif test == 1:
        print " Opti MiniP Demand: (" + str(mini1_thres) + ") " + str(optimised_demand) + " (" + str(len(optimised_demand)) + ")"
    ...
    if test == 1 and hh_threshold >= shift1_thres:
        print " Opti Shif1 Demand: (" + str(shift1_thres) + ") " + str(optimised_demand) + " (" + str(len(optimised_demand)) + ")"
    elif test == 1 and hh_threshold >= shift2_thres:
        print " Opti Shif2 Demand: (" + str(shift2_thres) + ") " + str(optimised_demand) + " (" + str(len(optimised_demand)) + ")"
    elif test == 1 and hh_threshold >= shift3_thres:
        print " Opti Shif3 Demand: (" + str(shift3_thres) + ") " + str(optimised_demand) + " (" + str(len(optimised_demand)) + ")"
    elif test == 1:
        print " Opti ShifP Demand: (" + str(shift3_thres) + ") " + str(optimised_demand) + " (" + str(len(optimised_demand)) + ")"
...
def test0():                    # test shifting
    ...
    cost_ = all_billing[1]
    expected_ = []
    appliancedemand = ida.deviceimport(housedata, min_interval, csv_directory, "No", "No", "No", "Yes", "No", "No",
                                       "No", "No", "No", "No", "No", "No", "No", "No")
    device_demand = appliancedemand[0][3]
    variation = dishwasher(device_demand, routine_, min_interval, cost_, threshold, shifting_, testing_)
...
def test1():
    ...
    device_data = []
    for row in df[1][9]:                                                            # <<<<----- Edit device number here
    ...
    for i in np.arange(7, 8):
        ...
        vari = dishwasher(device_data, routine_, min_interval, billing_info[1], hh_threshold, shifting_, 0)
