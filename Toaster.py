...
def toaster(device_demand, routine, mininterval, cost, hh_threshold, test):
    # general toaster inputs
    ...
    # inputs especially for toaster optimsiation using elimination:
    elim_thres = 10                              # how much effort it takes to eliminate device usage

    # inputs especially for toaster optimsiation using minimisation 1:
...
def test0():                    # test shifting
    ...
    device_demand = appliancedemand[0][12]
    variation = toaster(device_demand, routine_, min_interval, cost_, threshold, testing_)
